...
def posprocessing(x, min_points=1, verbose=False):
    """
...
features_path = f'./data/features_window_10.csv'
if not os.path.exists(features_path):
    # features_all = fts.get_all_features(dataset, n_dirs=n_dirs, win=window, eps=seconds)
    features = fts.get_features(dataset, eps=seconds)
